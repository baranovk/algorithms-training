...
public class NumberOfSmallestUnoccupiedChairTests
{
    ...
    public void Test_1()
    {
        ...
        var chair = NumberOfSmallestUnoccupiedChair.SmallestChair(times, 0);
    ...
    public void Test_2()
    {
        ...
        var chair = NumberOfSmallestUnoccupiedChair.SmallestChair(times, 1);
    ...
    public void Test_3()
    {
        ...
        var chair = NumberOfSmallestUnoccupiedChair.SmallestChair(times, 2);
        Assert.That(chair, Is.EqualTo(1));
    }
    ...
    public void Test_4()
    {
        ...
        var chair = NumberOfSmallestUnoccupiedChair.SmallestChair(times, 3);
        Assert.That(chair, Is.EqualTo(1));
    }
    ...
    public void Test_7()
    {
        ...
        var chair = NumberOfSmallestUnoccupiedChair.SmallestChair(times, 6);
        Assert.That(chair, Is.EqualTo(2));
    }
    ...
    public void Test_8()
    {
        ...
        var chair = NumberOfSmallestUnoccupiedChair.SmallestChair(times, 15);
        Assert.That(chair, Is.EqualTo(0));
    }
